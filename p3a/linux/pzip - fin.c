...
static size_t  fillptr = 0;
static size_t  useptr = 0;
static size_t  numfull = 0;
...
int main(int argc, char **argv){
	...
	//calculate totla number of chunks to be processed
	...
	for (int file = 1; file < num_files + 1;) {
		if (next) {
			...
			fstat(fil, &statbuf2);
			sizeinfileleft = (size_t) statbuf2.st_size;
			offset = 0;
			next = 0;
		}
